...
$action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-NoProfile -ExecutionPolicy Bypass -File D:\dotfiles\scripts\knowledge-watch.ps1 -Commit -Weekly"
